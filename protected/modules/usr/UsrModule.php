...
class UsrModule extends CWebModule
{
	...
	/*
	 * If login only for administration
	 * */
    public $afterLoginStaticAction = false;
    public $afterLoginUrl = 'admin/summary';

    /**
	 * @var boolean Is new user registration by admin enabled.
	 */
	public $adminRegistrationEnabled = true;
    /**
    ...
    /**
     * @var string Class name for grid view widget.
     */
    public $gridViewClass = 'zii.widgets.grid.CGridView';
	/**
	 * @var string CSS class for html forms.
	 */
	public $loginFormCssClass = 'form';
