	...
	IManagedIdentity
{
    ...
    public function authenticate()
    {
        ...
        if (UserLoginAttempt::hasTooManyFailedAttempts($this->username, self::MAX_FAILED_LOGIN_ATTEMPTS, self::LOGIN_ATTEMPTS_COUNT_SECONDS)) {
            ...
            $this->setState('initials', $record->lastname.' '.$record->firstname);
            $this->setState('picture', $this->getPictureUrl(25, 25));
	...
	{
		$allowedAttributes = array('username','email','firstName','lastName', 'role');
